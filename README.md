...
```ogdl
github "LaunchDarkly/swift-eventsource" ~> 3.4
```
...
```swift
dependencies: [
    .package(url: "https://github.com/LaunchDarkly/swift-eventsource.git", .upToNextMajor(from: "3.4.0"))
]
```
